...
import { AboutIlustration } from '../../assets/illustration/about-ilustration'
      ...
      <Layout
        section={
          <Flex height="100%" flexDirection="column" justifyContent="center">
            <Text>
              Sou desenvolvedora front-end com especialidade na web. Trabalho
              com o framework Next js utilizando o styled-components e a
              linguagem typescript, para uma melhor perfomace procuro sempre
              fazer tests com jest nas aplicações criadas. Estou no ramo desde
              2021, porem já venho estudando a mais tempo
            </Text>
            <Text>
            ...
            <Text>
              Hoje em dia procuro me aperfeiçoar com os padrões de projeto e
              sempre tento estar a par das novas tecnologias
            </Text>
            <Box>
